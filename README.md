...
| 폴더 | 버전 | 훅 | 목적 |
| --- | --- | --- | --- |
| [`speech-core`](speech-core/) | 0.1.2 | `pre_llm_call` | 설치된 스킬 본문 셋을 넣고, 한글 말투 수정을 덧붙입니다. |
...
스킬 파일이 없으면 그 이름만 알립니다. 빠진 본문을 다른 문단으로 대체하지 않습니다. 모델 설정과 도구는 바꾸지 않습니다. 수정 원문은 [`speech-core/__init__.py`](speech-core/__init__.py)에 있습니다.
